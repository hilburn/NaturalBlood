package naturalblood.reference;

public class Reference
{
    // User friendly version of our mods name.
    public static final String NAME = "Natural Blood";

    // Internal mod name used for reference purposes and resource gathering.
    public static final String ID = "NaturalBlood";

    public static final String DESCRIPTION = "Prevents Fake Players binding Blood Magic Items";
